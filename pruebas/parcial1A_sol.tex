...
conjuntos anteriores
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ {\binom{x}{x - 2}} = 10 $  \begin{solution}  $ \left\{5\right\} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \question Efectúa:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{\sqrt{3}}{\sqrt{3}-\sqrt{2}}-\frac{\sqrt{3}}{\sqrt{3}+\sqrt{2}} $  \begin{solution}  $ 2 \sqrt{6}\to2 \sqrt{6} $  \end{solution} \part[1]  $ \frac{\sqrt{7}-\sqrt{5}}{\sqrt{7}+\sqrt{5}}-\frac{\sqrt{7}+\sqrt{5}}{\sqrt{7}-\sqrt{5}} $  \begin{solution}  $ \frac{-12 - 2 \sqrt{35} + \left(- \sqrt{7} + \sqrt{5}\right)^{2}}{2}\to- 2 \sqrt{35} $  \end{solution}
        \end{parts}
        \end{multicols}
