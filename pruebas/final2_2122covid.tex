        ...
        % \part[1] Demuestra si los vectores forman base de $\mathbb{R}^2$  \begin{solution}  $ Point2D(4, -2), Point2D(4, -2): True $  \end{solution}
        % \end{parts}
        % % \end{multicols}
...
%         \end{multicols}
        ...
        \part[2] $\cos\dfrac{x}{3}=-\dfrac{1}{2}$\begin{solution}
        % map(deg,solve(cos(x/3)+1/2))
        $\left[ 360, \  720\right]$
        \end{solution}
        \part[2]$2 \sen^{2}x  + \cos2x=4 \cos^{2}x$\begin{solution}
        % map(deg,solve(2*sin(x)**2+cos(2*x)-4*cos(x)**2))
        $\left[ -120, \  -60, \  60, \  120\right]$
        \end{solution}
        % \part[2]  $ \sen{x}\cos{x}=2\sen{x} $  \begin{solution}  $ \left [ 0\right ] $  \end{solution}
        
        % \part[2]  $ \tan{x}-\sin{x}=0 $  \begin{solution}  $ \left [ 0, \quad -180, \quad 180, \quad 360\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \part[2]  $ ({\sqrt {3}  - i})\dfrac{{\sqrt{ 3} +i}}{{1 - 3i}} $  \begin{solution}  $ \frac{2}{5} + \frac{6 i}{5} $ 
        \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \part  $ 5_{\frac{\pi}{6}} $  \begin{solution}  $ \frac{5 \sqrt{3}}{2} + \frac{5 i}{2} $  \end{solution} 
        \part  $ \sqrt{5}_{\pi} $  \begin{solution}  $ - \sqrt{5} $  \end{solution} 
