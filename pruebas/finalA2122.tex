...
y expresa los resultados en forma de Intervalos.
  ...
  \begin{solution}  $ C=\left[-9, 15\right] \ \ A \cup  B = \left(-\infty, -3\right) \cup \left(3, \infty\right)  \\  A \cap B= \left[6, 8\right)   \\  (A \cup B) \cap C= \left[-9, -3\right) \cup \left(3, 15\right] $  \end{solution}
        ...
        \question Calcula:
        \begin{multicols}{1}
        \begin{parts} \part[1]  $ {( {\sqrt {7}  + \sqrt {3} } )^2}\cdot( {5 - \sqrt {21} }) $  \begin{solution}  $ 8 $  \end{solution} 
        % \part[1]  $ \dfrac{{3\sqrt{ 2 } - 2\sqrt {3} }}{{3\sqrt {2}  + 2\sqrt {3} }} - \dfrac{3}{{2\sqrt {6 }}} $  \begin{solution}  $ \dfrac{- 7 \sqrt{3} + 3 \sqrt{2}}{2 \left(2 \sqrt{3} + 3 \sqrt{2}\right)} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \question Resuelve:
        \begin{multicols}{1}
        \begin{parts} \part[1]  $ \sqrt {x + 5}  - \sqrt {x - 1}  = 2 $  \begin{solution}  $ \left [ \dfrac{5}{4}\right ] $  \end{solution} 
        % \part[1]  $ \dfrac{{7 - x}}{{x + 4}} - \dfrac{3}{{x - 5}} = \dfrac{{26x - 25}}{{{x^2} - x - 20}} + \dfrac{1}{3} $  \begin{solution}  $ \left [ - \dfrac{23}{2}, \quad -1\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resuelve :
        \begin{multicols}{1}
        ...
        \begin{multicols}{1}
        \begin{parts} \part[2]  $ \left\{\begin{matrix}2x - y + z = 6\\ 2x + 2y - 4z = 2\\ x - 2y + 3z = 0\\ \end{matrix}\right. $  \begin{solution}  $ \left[\begin{matrix}-1 & 2 & 1 & 6\\0 & 6 & -2 & 14\\0 & 0 & 0 & -5\end{matrix}\right] \rightarrow  \\ \left [ \right ] $  \end{solution} 
        % \part[1]  $ \left\{\begin{matrix}x + 2y - 3z = 9\\ 4x - 2y = 12\\ 4x + 3y - 6z = 24\\ \end{matrix}\right. $  \begin{solution}  $ \left[\begin{matrix}2 & 1 & -3 & 9\\0 & 5 & -3 & 21\\0 & 0 & 0 & 0\end{matrix}\right] \rightarrow  \\ \left \{ x : \dfrac{3 z}{5} + \dfrac{21}{5}, \quad y : \dfrac{6 z}{5} + \dfrac{12}{5}\right \} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \begin{multicols}{1}
        \begin{parts} \part[1]  $ P(x)=9x^2-mx+\dfrac{1}{4} \ no \ tenga\ ninguna \ ra \acute \imath z \ real $  \begin{solution}  $ \left [ 9, \quad - m, \quad \dfrac{1}{4}\right ]\to -3 < m \wedge m < 3 $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resuelve:
        \begin{multicols}{1}
        \begin{parts} 
        % \part[1]  $ \dfrac{{3x - 2}}{{x - 1}} - \dfrac{{3x + 2}}{{x + 1}} \geq \dfrac{{2x - 1}}{{x^2 - 1}} $  \begin{solution}  $ \left(-\infty, -1\right) \cup \left(1, \infty\right) $  \end{solution} 
        ...
        \begin{parts} 
         ...
         \part[2]  $$ \left\{\begin{matrix}x \geq 0 \\0 \leq y \leq 3\\x - 2y \leq 10\\x + y \geq 10\\\end{matrix}\right. $$  \begin{solution}   \\ \includegraphics[width=1\columnwidth]{si5}   \end{solution}  
        \end{parts}
