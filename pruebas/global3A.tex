...
\section*{1ª Evaluación}        
	...
	\end{gathered}  \right.$$  \begin{solution}   $(5,16)$   \end{solution}
        ...
        \question[1] Resuelve:
        \begin{multicols}{2}
        \begin{parts} \part $3^{x^2-5x}=9^{-3}$  \begin{solution}   $(5,16)$   \end{solution}
...
\section*{2ª Evaluación}
        ...
        \part $$\cos{x}=\sin^2{x}-1$$ \begin{solution}   -90, 90   \end{solution} 
         \end{parts}
        \end{multicols}
        ...
        \part $\cos\alpha$  \begin{solution}   $- \frac{12}{13}$\   \end{solution}
                ...
                \part $\cos(\pi+\alpha)$  \begin{solution}   $\frac{5}{13}$\   \end{solution}
