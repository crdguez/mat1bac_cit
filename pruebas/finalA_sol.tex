...
\begin{itemize} \item la mediana correspondiente al vértice A \item la mediatriz correspondiente al lado AB \item y el área \end{itemize} Siendo:
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ 2 - 2\sqrt {3}i $  \begin{solution}  $ 4_{- \frac{\pi}{3}} $  \end{solution} \part[1]  $ -4 $  \begin{solution}  $ 4_{\pi} $  \end{solution} \part[1]  $ 2i $  \begin{solution}  $ 2_{\frac{\pi}{2}} $  \end{solution}
        \end{parts}
        \end{multicols}
