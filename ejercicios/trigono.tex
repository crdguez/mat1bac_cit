        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1] El lado a=8, y los ángulos B=30º, y C=105º  \begin{solution}  $ 8 + 8 \sqrt{3} \to 21.856406460551018 $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1] a=25km, b=28, y sen(C)=0.96, siendo C < 90º  \begin{solution}  $ 336.0º $  \end{solution}
        \end{parts}
        \end{multicols}
