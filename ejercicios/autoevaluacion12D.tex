        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \left|{3 x + 4}\right| - 5> 0 $  \begin{solution}  $ \left(-\infty < x \wedge x < -3\right) \vee \left(\frac{1}{3} < x \wedge x < \infty\right) $  \end{solution} \part[1]  $ \left|{2 x - 4}\right| - 2> 0 $  \begin{solution}  $ \left(-\infty < x \wedge x < 1\right) \vee \left(3 < x \wedge x < \infty\right) $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Efectúa simplificando el resultado si es posible:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{1}{{\frac{{x + 1}}{{x - 1}} - \frac{{x - 1}}{{x + 1}}}} $  \begin{solution}  $ \frac{x^{2} - 1}{4 x} $  \end{solution} \part[1]  $ \frac{3x^2+1}{x^2+x}  - \frac{2x}{x+1} $  \begin{solution}  $ \frac{x^{2} + 1}{x^{2} + x} $  \end{solution} \part[1]  $ \frac{\frac{x^2-2x+1}{x + 3}}{\frac{x-1}{x^2 -9 }} $  \begin{solution}  $ x^{2} - 4 x + 3 $  \end{solution} \part[1]  $ \frac{1}{x^2-x} + \frac{2x-1}{x-1} - \frac{3x-1}{x} $  \begin{solution}  $ - \frac{x - 3}{x - 1} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resuelve mediante expresiones algebraicas:
        \begin{multicols}{1} 
        \begin{parts} \part[1] En una clase los 2/3 del número de alumnas es igual a los 5/7 del número de alumnos. Si el número de
