        ...
        \begin{multicols}{4} 
        \begin{parts} \part[1]  $ \log(16) $  \begin{solution}  $ 1.20411998265592 $  \end{solution} \part[1]  $ \log(64) $  \begin{solution}  $ 1.80617997398389 $  \end{solution} \part[1]  $ \log(1024) $  \begin{solution}  $ 3.01029995663981 $  \end{solution} \part[1]  $ \log(\frac{1}{2}) $  \begin{solution}  $ -0.301029995663981 $  \end{solution} \part[1]  $ \log(\frac{1}{16}) $  \begin{solution}  $ -1.20411998265592 $  \end{solution} \part[1]  $ \log(5) $  \begin{solution}  $ 0.698970004336019 $  \end{solution} \part[1]  $ \log(25) $  \begin{solution}  $ 1.39794000867204 $  \end{solution} \part[1]  $ \log(0.0016) $  \begin{solution}  $ -2.79588001734407 $  \end{solution} \part[1]  $ \log(\sqrt[ 4 ]{\frac{1}{{0.04}}} ) $  \begin{solution}  $ 0.349485002168009 $  \end{solution} \part[1]  $ \log{\sqrt[ 3 ]{0.002}} $  \begin{solution}  $ -0.899656668112007 $  \end{solution} \part[1]  $ \log(0.025) $  \begin{solution}  $ -1.60205999132796 $  \end{solution} \part[1]  $ \log(\sqrt[ 4 ]{\frac{1}{{1024}}} ) $  \begin{solution}  $ -0.752574989159953 $  \end{solution}
        \end{parts}
        \end{multicols}
