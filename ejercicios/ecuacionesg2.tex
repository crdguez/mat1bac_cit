        ...
        \end{parts}
        \end{multicols}
        \question p018e22 - Calcula un número que sumado con el doble de su raíz cuadrada nos de 24.
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ 2 \sqrt{x} + x = 24 $  \begin{solution}  $ \left\{16\right\} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ x + y - 11 = 0\land\left(x + 10 y\right) \left(10 x + y\right) - 3154 = 0 $  \begin{solution}  $ \left [ \left ( 3, \quad 8\right ), \quad \left ( 8, \quad 3\right )\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
...
Si a los tres les añadimos una misma longitud, el triángulo construido con ellos es rectángulo. Halla dicha longitud.
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \left(x + 8\right)^{2} + \left(x + 22\right)^{2} = \left(x + 24\right)^{2} $  \begin{solution}  $ \left\{2\right\} $  \end{solution}
        \end{parts}
        \end{multicols}
...
la hipotenusa. Halla los tres lados del triángulo.
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ x + 2 y - 87 = 0\land x^{2} + y^{2} - \left(y + 3\right)^{2} = 0 $  \begin{solution}  $ \left [ \left ( -18, \quad \frac{105}{2}\right ), \quad \left ( 15, \quad 36\right )\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
...
Si el área de las calles es de 4000 m² , ¿cuál es su anchura?
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \left(x + 80\right) \left(x + 100\right) - 8000 = 4000 $  \begin{solution}  $ \left\{20\right\} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p018e29 - Halla dos números cuya suma es 14 y la de sus cuadrados 100.
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ x + y - 14 = 0\land x^{2} + y^{2} - 100 = 0 $  \begin{solution}  $ \left [ \left ( 6, \quad 8\right ), \quad \left ( 8, \quad 6\right )\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p018e30 - Halla dos números positivos cuya diferencia sea 7 y la suma de sus cuadrados 3809.
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ x - y - 7 = 0\land x^{2} + y^{2} - 3809 = 0 $  \begin{solution}  $ \left ( 47, \quad 40\right ) $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p018e31 - Resuelve mediante expresiones algebraicas:
        \begin{multicols}{1} 
...
la hipotenusa. Halla los tres lados del triángulo.  \begin{solution}  $ x + 2 y - 87 = 0\land x^{2} + y^{2} - \left(y + 3\right)^{2} = 0\to \left [ \left ( -18, \quad \frac{105}{2}\right ), \quad \left ( 15, \quad 36\right )\right ] $  \end{solution} \part[1] Halla dos números cuya suma es 14 y la de sus cuadrados 100.  \begin{solution}  $ x + y - 14 = 0\land x^{2} + y^{2} - 100 = 0\to \left [ \left ( 6, \quad 8\right ), \quad \left ( 8, \quad 6\right )\right ] $  \end{solution} \part[1] Halla dos números positivos cuya diferencia sea 7 y la suma de sus cuadrados 3809.  \begin{solution}  $ x - y - 7 = 0\land x^{2} + y^{2} - 3809 = 0\to \left [ \left ( -40, \quad -47\right ), \quad \left ( 47, \quad 40\right )\right ] $  \end{solution} \part[1] Una habitación rectangular tiene una superficie de 28 m² y 
    ...
    dimensiones de la habitación.  \begin{solution}  $ x y - 28 = 0\land 2 x + 2 y - 22 = 0\to \left [ \left ( 4, \quad 7\right ), \quad \left ( 7, \quad 4\right )\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
