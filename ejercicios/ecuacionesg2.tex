...
Si el área de las calles es de 4000 m² , ¿cuál es su anchura?
        ...
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ x - y - 7 = 0\land x^{2} + y^{2} - 3809 = 0 $  \begin{solution}  $ \left ( 47, \quad 40\right ) $  \end{solution} \part[1]  $ x y - 28 = 0\land 2 x + 2 y - 22 = 0 $  \begin{solution}  $ \left [ \left ( 4, \quad 7\right ), \quad \left ( 7, \quad 4\right )\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
