...
Si el área de las calles es de 4000 m² , ¿cuál es su anchura?  \begin{solution}  $ \left(2 x + 80\right) \left(2 x + 100\right) - 12000 = 0\to \left\{10\right\} $  \end{solution} \part[1] En cada esquina de una hoja de papel cuadrada se recorta un cuadrado de 5 cm de lado, y entonces,
