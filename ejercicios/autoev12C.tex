        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{\frac{x^2-2x+1}{x + 3}}{\frac{x-1}{x^2 -9 }} $  \begin{solution}  $ x^{2} - 4 x + 3 $  \end{solution} \part[1]  $ \frac{1}{x}( {\frac{2}{x} - \frac{3x}{{x + 1}}} ) - \frac{{x}}{x-1}( {3 - \frac{4}{{x + 1}}} ) $  \begin{solution}  $ - \frac{3 x^{4} + 2 x^{3} - 5 x^{2} + 2}{x^{4} - x^{2}} $  \end{solution}
        \end{parts}
        \end{multicols}
    ...
    ¿Cuántos billetes hay de cada clase?  \begin{solution}  $ \left\{\begin{matrix}140=5x+10y\\ 20=x+y\\ \end{matrix}\right.  \rightarrow  \\\left[\begin{matrix}10 & 5 & 140\\0 & \frac{1}{2} & 6\end{matrix}\right] \rightarrow  \left \{ x : 12, \quad y : 8\right \} $  \end{solution} \part[1] En un corral hay conejos y gallinas, en total 50 cabezas y 140 patas. 
    ¿Cuántos animales hay de cada clase?  \begin{solution}  $ \left\{\begin{matrix}50=x+y\\ 140=4x+2y\\ \end{matrix}\right.  \rightarrow  \\\left[\begin{matrix}1 & 1 & 50\\0 & 2 & 40\end{matrix}\right] \rightarrow  \left \{ x : 20, \quad y : 30\right \} $  \end{solution}
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \left\{\begin{matrix}\frac{{3( {2 - x} )}}{2} - x < \frac{{16}}{3} - \frac{{x + 1}}{5} \\\frac{{x + 4}}{3} - \frac{{x - 5}}{6} > 3 - \frac{{2x - 3}}{{18}}\end{matrix}\right. $  \begin{solution}  $ \left(\frac{18}{5}, \infty\right) $  \end{solution} \part[1]  $ \left\{\begin{matrix}{( {x - 1} )^2} - {( {x - 3} )^2} \leq 0\\x - 3( {x + 1}^2 ) \leq 3 \end{matrix}\right. $  \begin{solution}  $ \left(-\infty, 2\right] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resuelve los siguientes sistemas de inecuaciones:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \left\{\begin{matrix}x \geq 0 \\0 \leq y\\y \leq 3\\x - 2y \leq 10\\x + y \geq 10\\\end{matrix}\right. $  \begin{solution}    \includegraphics[width=1\columnwidth]{si5}   \end{solution} \part[1]  $ \left\{\begin{matrix}2x - y < 1 \\ - x + 4y \geq  - 5\\\end{matrix}\right. $  \begin{solution}    \includegraphics[width=1\columnwidth]{si1}   \end{solution}
        \end{parts}
        \end{multicols}
        \question Averigua el valor de x en los siguientes casos:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \log x + \log (50) = \log (1000) $  \begin{solution}  $ \left [ 20\right ] $  \end{solution} \part[1]  $ \log (x^3) = \log (6) + 2 \log (x) $  \begin{solution}  $ \left [ 6\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
