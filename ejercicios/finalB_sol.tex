...
Indica además, si existe, el máximo y el mínimo de cada uno de los conjuntos resultado.
        ...
        \question Calcular:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{3\sqrt{ 2 } - 2\sqrt {3} }}{{3\sqrt {2}  + 2\sqrt {3} }} - \frac{3}{{2\sqrt {6 }}} $  \begin{solution}  $ \frac{- 7 \sqrt{3} + 3 \sqrt{2}}{2 \left(2 \sqrt{3} + 3 \sqrt{2}\right)} $  \end{solution} \part[1]  $ {( {\sqrt {7}  + \sqrt {3} } )^2}\cdot( {5 - \sqrt {21} }) $  \begin{solution}  $ 8 $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \question Resuelve:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{7 - x}}{{x + 4}} - \frac{3}{{x - 5}} = \frac{{26x - 25}}{{{x^2} - x - 20}} + \frac{1}{3} $  \begin{solution}  $ \left [ - \frac{23}{2}, \quad -1\right ] $  \end{solution} \part[1]  $ \sqrt {x + 5}  - \sqrt {x - 1}  = 2 $  \begin{solution}  $ \left [ \frac{5}{4}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resolver :
        \begin{multicols}{1} 
        ...
        \question Resuelve:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{{x^3} - 5{x^2} + 2x + 8}}{x^2+1} < 0 $  \begin{solution}  $ \left(-\infty, -1\right) \cup \left(2, 4\right) $  \end{solution} \part[1]  $ \frac{{3x - 2}}{{x - 1}} - \frac{{3x + 2}}{{x + 1}} \geq \frac{{2x - 1}}{{x^2 - 1}} $  \begin{solution}  $ \left(-\infty, -1\right) \cup \left(1, \infty\right) $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Calcula expresando el resultado en forma de fracción algebraica irreducible:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{x^3}-x^2 -4x + 4}{{x^2} - 3x + 2}:\frac{{x^3} - {x^2} + 3x - 3}{{{x^3} + 3x}} $  \begin{solution}  $ \frac{x^{2} + 2 x}{x - 1} $  \end{solution}
        \end{parts}
        \end{multicols}
