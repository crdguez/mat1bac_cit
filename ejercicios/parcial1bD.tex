...
Indica además, si existe, el supremo y el ínfimo de cada uno.de los conjuntos resultado.
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ {\binom{23}{x}} = \binom{23}{3x-1} $  \begin{solution}  $ \left\{6\right\} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Encontrar, sin hacer todo el desarrollo, el término central del desarrollo del siguiente polinomio:
        \begin{multicols}{1} 
        \begin{parts} \part[2]  $ P(x)=\left(x^{2} + x\right)^{4} \,  $  \begin{solution}  $ 6 x^{6} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Efectúa:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{2 - \sqrt {3} }}{{1 - \sqrt {3} }}-\frac{1}{2\sqrt {3}}+ \frac{3}{2-\sqrt{3} } $  \begin{solution}  $ \frac{14 \sqrt{3} + 39}{6}\to\frac{7 \sqrt{3}}{3} + \frac{13}{2} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Calcula el valor de $m$ para que:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ P(x)=\frac{x^2}{16}-mx+\frac{9}{4} \ tenga\ una \ ra \acute \imath z \ doble $  \begin{solution}  $ \left [ \frac{1}{16}, \quad - m, \quad \frac{9}{4}\right ]\to \left [ - \frac{3}{4}, \quad \frac{3}{4}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Calcula expresando el resultado en forma de fracción algebraica irreducible:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{1+{ \frac{1}{x}}}{{1 + \frac{1}{{1 + \frac{1}{x}}}}} $  \begin{solution}  $ \frac{x^{2} + 2 x + 1}{2 x^{2} + x} $  \end{solution} \part[1]  $ \frac{{x^3}-x^2 -4x + 4}{{x^2} - 3x + 2}:\frac{{x^3} - {x^2} + 3x - 3}{{{x^3} + 3x}} $  \begin{solution}  $ \frac{x^{2} + 2 x}{x - 1} $  \end{solution} \part[1]  $ \frac{{\frac{1}{{x - 3}} - \frac{1}{{x + 3}}}}{{1 - \frac{3}{{{x^2} - 9}}}} $  \begin{solution}  $ \frac{6}{x^{2} - 12} $  \end{solution}
        \end{parts}
        \end{multicols}
