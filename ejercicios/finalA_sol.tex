...
Indica además, si existe, el máximo y el mínimo de cada uno de los conjuntos resultado.
        ...
        \question Calcular:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{3\sqrt{ 2 } - 2\sqrt {3} }}{{3\sqrt {2}  + 2\sqrt {3} }} - \frac{3}{{2\sqrt {6 }}} $  \begin{solution}  $ \frac{- 7 \sqrt{3} + 3 \sqrt{2}}{2 \left(2 \sqrt{3} + 3 \sqrt{2}\right)} $  \end{solution} \part[1]  $ \frac{16\cdot\sqrt[3]{4}( {\sqrt {2} } )^3}{\sqrt{2\sqrt [3] {4} } } $  \begin{solution}  $ 32 \sqrt[3]{2} $  \end{solution}
        \end{parts}
        \end{multicols}
