        ...
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ (k+5i) + (3+i) = (1+5i) + (-k+i) $  \begin{solution}  $ \left [ -1\right ] $  \end{solution} \part[1]  $ (1+3i)(k+2i) = 13+59i $  \begin{solution}  $ \left \{ k : 19\right \} $  \end{solution} \part[1]  $ k+\frac{4}{5}i=\frac{5+i}{3-i} $  \begin{solution}  $ \left [ \right ] $  \end{solution}
        \end{parts}
        \end{multicols}
