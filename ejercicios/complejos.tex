        ...
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ (k-i)^3 $  \begin{solution}  $ k^{3} - 3 i k^{2} - 3 k + i\to\left [ - \frac{\sqrt{3}}{3}, \quad \frac{\sqrt{3}}{3}\right ] $  \end{solution} \part[1]  $ (k-i)^3 $  \begin{solution}  $ k^{3} - 3 i k^{2} - 3 k + i\to\left [ - \frac{\sqrt{3}}{3}, \quad \frac{\sqrt{3}}{3}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \end{parts}
        \end{multicols}
        \question p047e40 - Determina el valor que han de tener a y k para que sean iguales los siguientes números:
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \frac{a + 2 i}{3+k\cdot i} \ y \sqrt{2}_{\frac{7 \pi}{4}} $  \begin{solution}  $ \left [ \left \{ a : 8, \quad k : 5\right \}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p047e41 - Hallar la ecuación de segundo grado cuyas raíces sean los números complejos:
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ 2_{\frac{\pi}{3}} \ y \ 2_{\frac{5 \pi}{3}} $  \begin{solution}  $ x^{2} - 2 x + 4=0 $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p047e51 - Calcula dos números complejos conjugados cuya suma y la suma de sus módulos sea respectivamente
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ 8\ y \ 10 $  \begin{solution}  $ 4 - 3 i\land4 + 3 i $  \end{solution}
        \end{parts}
        \end{multicols}
