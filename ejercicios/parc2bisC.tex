...
y $\angle(\overrightarrow{u},\overrightarrow{v})$ siendo:
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \cos(\pi+\alpha) $  \begin{solution}  $ \frac{3}{5} $  \end{solution} \part[1]  $ \sin\alpha $  \begin{solution}  $ - \frac{3}{5} $  \end{solution} \part[1]  $ \tan\alpha $  \begin{solution}  $ \frac{3}{4} $  \end{solution} \part[1]  $ \sin(2\alpha) $  \begin{solution}  $ \frac{24}{25} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[3] Los lados a=40 cm y b=10 cm, y C=30º  \begin{solution}  $ \sqrt{- 400 \sqrt{3} + 1700} = 31.73609422995289,\ 140.9353216114064º,\ 9.0646783885936º, \ 81.7360942299529 cm2 $  \end{solution}
        \end{parts}
        \end{multicols}
