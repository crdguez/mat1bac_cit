...
Indica además, si existe, el máximo y el mínimo de cada uno de los conjuntos resultado.
        ...
        \question Calcular:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \dfrac{{3\sqrt{ 2 } - 2\sqrt {3} }}{{3\sqrt {2}  + 2\sqrt {3} }} - \dfrac{3}{{2\sqrt {6 }}} $  \begin{solution}  $ \dfrac{- 7 \sqrt{3} + 3 \sqrt{2}}{2 \left(2 \sqrt{3} + 3 \sqrt{2}\right)} $  \end{solution} \part[1]  $ \dfrac{16\cdot\sqrt[3]{4}( {\sqrt {2} } )^3}{\sqrt{2\sqrt [3] {4} } } $  \begin{solution}  $ 32 \sqrt[3]{2} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \question Resuelve:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \sqrt {x + 5}  - \sqrt {x - 1}  = 2 $  \begin{solution}  $ \left [ \dfrac{5}{4}\right ] $  \end{solution} \part[1]  $ \dfrac{{7 - x}}{{x + 4}} - \dfrac{3}{{x - 5}} = \dfrac{{26x - 25}}{{{x^2} - x - 20}} + \dfrac{1}{3} $  \begin{solution}  $ \left [ - \dfrac{23}{2}, \quad -1\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resolver :
        \begin{multicols}{1} 
        ...
        \question Resuelve:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \dfrac{{3x - 2}}{{x - 1}} - \dfrac{{3x + 2}}{{x + 1}} \geq \dfrac{{2x - 1}}{{x^2 - 1}} $  \begin{solution}  $ \left(-\infty, -1\right) \cup \left(1, \infty\right) $  \end{solution} \part[1]  $ \dfrac{{{x^3} - 5{x^2} + 2x + 8}}{x^2+1} < 0 $  \begin{solution}  $ \left(-\infty, -1\right) \cup \left(2, 4\right) $  \end{solution}
        \end{parts}
        \end{multicols}
