...
Indica además, si existe, el supremo y el ínfimo de cada uno.de los conjuntos resultado.
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[2]  $ P(x)=\left(3 x^{2} - \frac{3}{x}\right)^{10} \,  $  \begin{solution}  $ - 14880348 x^{10} $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Efectúa:
        \begin{multicols}{1} 
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{\frac{1}{{x - 3}} - \frac{1}{{x + 3}}}}{{1 - \frac{3}{{{x^2} - 9}}}} $  \begin{solution}  $ \frac{6}{x^{2} - 12} $  \end{solution} \part[1]  $ \frac{{x^3}-x^2 -4x + 4}{{x^2} - 3x + 2}:\frac{{x^3} - {x^2} + 3x - 3}{{{x^3} + 3x}} $  \begin{solution}  $ \frac{x^{2} + 2 x}{x - 1} $  \end{solution} \part[1]  $ \frac{1+{ \frac{1}{x}}}{{1 + \frac{1}{{1 + \frac{1}{x}}}}} $  \begin{solution}  $ \frac{x^{2} + 2 x + 1}{2 x^{2} + x} $  \end{solution}
        \end{parts}
        \end{multicols}
