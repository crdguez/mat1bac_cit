...
y $\angle(\overrightarrow{u},\overrightarrow{v})$ siendo:
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \overrightarrow{u}=(2, -3) \, \ \overrightarrow{v}=(5, 4) $  \begin{solution}  $ [-2, [sqrt(13), sqrt(41)], 94.9697407281103] $  \end{solution} \part[1]  $ \overrightarrow{u}=(1, 2) \, \ \overrightarrow{v}=(3, 4) $  \begin{solution}  $ [11, [sqrt(5), 5], 10.3048464687660] $  \end{solution} \part[1]  $ \overrightarrow{u}=(1, 1) \, \ \overrightarrow{v}=(-2, -3) $  \begin{solution}  $ [-5, [sqrt(2), sqrt(13)], 168.690067525980] $  \end{solution}
        \end{parts}
        \end{multicols}
