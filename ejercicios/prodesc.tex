...
$\overrightarrow{u}$, calcula x de modo que sea ortogonal a $\overrightarrow{v}$ siendo: 
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \overrightarrow{u}=(-5, x) \, \ \overrightarrow{v}=(4, -2) $  \begin{solution}  $ \left [ -10\right ] $  \end{solution} \part[1]  $ \overrightarrow{u}=(2, x) \, \ \overrightarrow{v}=(3, 1) $  \begin{solution}  $ \left [ -6\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
...
$\overrightarrow{u}$ y $\overrightarrow{v}$ formen 60º siendo: 
        \begin{multicols}{2} 
        \begin{parts} \part[1]  $ \overrightarrow{u}=(3, x) \, \ \overrightarrow{v}=(5, 2) $  \begin{solution}  $ \left [ \frac{120}{13} + \frac{87 \sqrt{3}}{13}, \quad - \frac{87 \sqrt{3}}{13} + \frac{120}{13}\right ] $  \end{solution} \part[1]  $ \overrightarrow{u}=(2, x) \, \ \overrightarrow{v}=(3, 1) $  \begin{solution}  $ \left [ 4 + \frac{10 \sqrt{3}}{3}, \quad - \frac{10 \sqrt{3}}{3} + 4\right ] $  \end{solution} \part[1]  $ \overrightarrow{u}=(1, 0) \, \ \overrightarrow{v}=(1, x) $  \begin{solution}  $ \left [ - \sqrt{3}, \quad \sqrt{3}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question p036e16 - Halla las coordenadas de un cierto vector
...
módulos de ambos vectores son iguales, siendo: 
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \overrightarrow{v}=(2, 4) $  \begin{solution}  $ \left [ \left \{ x : - \sqrt{- 4 \sqrt{3} + 13}, \quad y : \sqrt{3} + 2\right \}, \quad \left \{ x : \sqrt{4 \sqrt{3} + 13}, \quad y : - \sqrt{3} + 2\right \}\right ] $  \end{solution} \part[1]  $ \overrightarrow{v}=(2, 3) $  \begin{solution}  $ \left [ \left \{ x : - \frac{\sqrt{- 12 \sqrt{3} + 31}}{2}, \quad y : \frac{3}{2} + \sqrt{3}\right \}, \quad \left \{ x : \frac{\sqrt{12 \sqrt{3} + 31}}{2}, \quad y : - \sqrt{3} + \frac{3}{2}\right \}\right ] $  \end{solution} \part[1]  $ \overrightarrow{v}=(1, 0) $  \begin{solution}  $ \left [ \left \{ x : \frac{1}{2}, \quad y : - \frac{\sqrt{3}}{2}\right \}, \quad \left \{ x : \frac{1}{2}, \quad y : \frac{\sqrt{3}}{2}\right \}\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
