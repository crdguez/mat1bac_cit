...
\end{tabular}   \end{solution} \part[1] Realiza un diagrama de barras y un polígono de frecuencias  \begin{solution}   \\ \includegraphics[width=1\columnwidth]{p089e02}   \end{solution} \part[1] Calcular los parámetros de centralización  \begin{solution}   {'media': 13.833333333333334, 'mediana': 14.0, 'moda': ModeResult(mode=array([11]), count=array([4]))}   \end{solution} \part[1] Calcular los parámetros de posición  \begin{solution}   {'Q1': 11.75, 'Q3': 16.0}   \end{solution} \part[1] Calcular los parámetros de dispersión  \begin{solution}   {'rango': 8, 'varianza': 6.222222222222221, 'desviación típica': 2.49443825784929, 'coeficiente variación': 0.180320837916816}   \end{solution}
        \end{parts}
        \end{multicols}
        \question p089e03 - Al preguntar a 20 individuos sobre el número de libros que han leído en el último mes: 3 2 3 2 1
                    3 4 2 4 3
                    4 3 1 3 2
                    2 5 2 3 3
        \begin{multicols}{1} 
...
\hline
     1 &     2 &     2 &  0.1  &  0.1  &    10 &     10 \\
     2 &     6 &     8 &  0.3  &  0.4  &    30 &     40 \\
     3 &     8 &    16 &  0.4  &  0.8  &    40 &     80 \\
     4 &     3 &    19 &  0.15 &  0.95 &    15 &     95 \\
     5 &     1 &    20 &  0.05 &  1    &     5 &    100 \\
\hline
\end{tabular}   \end{solution} \part[1] Realiza un diagrama de barras y un polígono de frecuencias  \begin{solution}   \\ \includegraphics[width=1\columnwidth]{p089e03}   \end{solution} \part[1] Calcular los parámetros de centralización  \begin{solution}   {'media': 2.75, 'mediana': 3.0, 'moda': ModeResult(mode=array([3]), count=array([8]))}   \end{solution} \part[1] Calcular los parámetros de posición  \begin{solution}   {'Q1': 2.0, 'Q3': 3.0}   \end{solution} \part[1] Calcular los parámetros de dispersión  \begin{solution}   {'rango': 4, 'varianza': 0.9875, 'desviación típica': 0.993730345717590, 'coeficiente variación': 0.361356489351851}   \end{solution}
        \end{parts}
        \end{multicols}
