    ...
    \question p12e10 - ¿Tiene el polinomio A(x)= $x^4 +3$ alguna raíz real?
        ...
        \end{parts}
        \end{multicols}
        \question p12e7 - Halla el cociente y el resto de:
        \begin{multicols}{3} 
        ...
        \end{parts}
        \end{multicols}
        \question p12e8 - Dados $ A(x)= - {x^3} + 2{x^2} + 5, \  B(x)= 2{x^4} + 3x + 6$ halla el valor numérico de ambos polinomios en:
        \begin{multicols}{3} 
        ...
        \end{parts}
        \end{multicols}
        \question p12e9 - Halla, para cada uno  de los siguientes polinomios, sus raíces:
        \begin{multicols}{3} 
