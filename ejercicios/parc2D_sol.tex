...
y $\angle(\overrightarrow{u},\overrightarrow{v})$ siendo:
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \cos\alpha $  \begin{solution}  $ - \frac{4}{5} $  \end{solution} \part[1]  $ \cos(\pi+\alpha) $  \begin{solution}  $ \frac{3}{5} $  \end{solution} \part[1]  $ \sin(2\alpha) $  \begin{solution}  $ \frac{24}{25} $  \end{solution} \part[1]  $ \tan\alpha $  \begin{solution}  $ \frac{3}{4} $  \end{solution}
        \end{parts}
        \end{multicols}
