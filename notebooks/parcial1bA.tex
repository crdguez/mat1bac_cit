...
Indica además, si existe, el máximo y el mínimo de cada uno de los conjuntos resultado.
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ A=\left\{ x \in \mathbb{R}| 3 \leq x \wedge x < 10 \right\}, \\ B=\left(-\infty, 1\right) \cup \left(3, \infty\right)  y \\  C=\left\{ x \in \mathbb{R}| \left|{x - 2}\right|\geq8 \right\} \\ $  \begin{solution}  $ C=\left(-\infty, -6\right] \cup \left[10, \infty\right) \ \ A \cup  B = \left(-\infty, 1\right) \cup \left[3, \infty\right)  \\  A \cap B= \left(3, 10\right)   \\  (A \cup B) \cap C= \left(-\infty, -6\right] \cup \left[10, \infty\right) $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Calcular:
        \begin{multicols}{1} 
        ...
        \question Resuelve:
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \frac{{7 - x}}{{x + 4}} - \frac{3}{{x - 5}} = \frac{{26x - 25}}{{{x^2} - x - 20}} + \frac{1}{3} $  \begin{solution}  $ \left [ - \frac{23}{2}, \quad -1\right ] $  \end{solution}
        \end{parts}
        \end{multicols}
        \question Resolver :
        \begin{multicols}{1} 
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ \left\{\begin{matrix}x + 2y - 3z = 9\\ 4x - 2y = 12\\ 4x + 3y - 6z = 24\\ \end{matrix}\right. $  \begin{solution}  $ \left[\begin{matrix}1 & -3 & 2 & 9\\0 & 12 & -10 & -24\\0 & 0 & 0 & 0\end{matrix}\right] \rightarrow  \\ \left \{ x : \frac{3 z}{5} + \frac{21}{5}, \quad y : \frac{6 z}{5} + \frac{12}{5}\right \} $  \end{solution}
        \end{parts}
        \end{multicols}
        ...
        \begin{multicols}{1} 
        \begin{parts} \part[1]  $ P(x)=16x^2-mx+\frac{9}{4} \ no \ tenga\ ninguna \ ra \acute \imath z \ real $  \begin{solution}  $ \left [ 16, \quad - m, \quad \frac{9}{4}\right ]\to -12 < m \wedge m < 12 $  \end{solution}
        \end{parts}
        \end{multicols}
